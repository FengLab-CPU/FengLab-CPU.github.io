...
<style>
    ...
    /* iPhone specific optimizations - HORIZONTAL LAYOUT */
    ...
    /* iPhone 14/15/16 specific optimization */
    ...
    /* Mobile-first horizontal layout for all small screens */
...
<div class="people-container">
    ...
    <div class="lab-section">
        ...
        <div class="people-grid">
            ...
            <div class="person-card">
                <div class="person-photo"><img src="/assets/images/fu-jieling.jpg" alt="Fu Jieling"></div>
                <div class="person-info">
                    <div class="person-name">Fu Jieling</div>
                    <div class="person-title">Lab Manager</div>
                </div>
            </div>

            <div class="person-card">
                <div class="person-photo"><img src="/assets/images/han-moqi.jpg" alt="Han Moqi"></div>
                <div class="person-info">
                    <div class="person-name">Han Moqi</div>
                    <div class="person-title">Undergraduate Student</div>
                    <div class="person-dept">Class of 2024</div>
                </div>
            </div>

            <div class="person-card">
                <div class="person-photo"><img src="/assets/images/zhou-yi.jpg" alt="Zhou Yi"></div>
                <div class="person-info">
                    <div class="person-name">Zhou Yi</div>
                    <div class="person-title">Master's Student</div>
                    <div class="person-dept">Class of 2026</div>
                </div>
            </div>

            <div class="person-card">
                <div class="person-photo"><img src="/assets/images/yao-siyi.jpg" alt="Yao Siyi"></div>
                <div class="person-info">
                    <div class="person-name">Yao Siyi</div>
                    <div class="person-title">Undergraduate Student</div>
                    <div class="person-dept">Clinical Pharmacy, Class of 2022</div>
                    <div class="person-dept">3+1+X Program</div>
                </div>
            </div>
            ...
            <div class="person-card">
                <div class="person-photo">👨‍🎓</div>
                <div class="person-info">
                    <div class="person-name">Zeng Junjie</div>
                    <div class="person-title">Undergraduate Student</div>
                    <div class="person-dept">Clinical Pharmacy, Class of 2022</div>
                    <div class="person-dept">3+1+X Program</div>
                </div>
